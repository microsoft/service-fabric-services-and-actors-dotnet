...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="BRSErrorClusterEvent" />.
    /// </summary>
    internal class BRSErrorClusterEventConverter
    {
        /// <summary>
        ...
        internal static BRSErrorClusterEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static BRSErrorClusterEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new BRSErrorClusterEvent(
        ...
        internal static void Serialize(JsonWriter writer, BRSErrorClusterEvent obj)
        {
