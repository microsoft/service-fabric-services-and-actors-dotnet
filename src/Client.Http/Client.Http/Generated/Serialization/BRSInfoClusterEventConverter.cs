...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="BRSInfoClusterEvent" />.
    /// </summary>
    internal class BRSInfoClusterEventConverter
    {
        /// <summary>
        ...
        internal static BRSInfoClusterEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static BRSInfoClusterEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new BRSInfoClusterEvent(
        ...
        internal static void Serialize(JsonWriter writer, BRSInfoClusterEvent obj)
        {
