...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ImpactSelector" />.
    /// </summary>
    internal class ImpactSelectorConverter
    {
        /// <summary>
        ...
        internal static ImpactSelector Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ImpactSelector GetFromJsonProperties(JsonReader reader)
        {
            ...
            do
            {
                ...
                if (string.Compare("IdFilter", propName, StringComparison.OrdinalIgnoreCase) == 0)
                {
                    idFilter = reader.ReadValueAsGuid();
                }
                else if (string.Compare("TypeFilter", propName, StringComparison.OrdinalIgnoreCase) == 0)
                {
                    typeFilter = ImpactTypeConverter.Deserialize(reader);
                }
                else if (string.Compare("StatusFilter", propName, StringComparison.OrdinalIgnoreCase) == 0)
                {
        ...
        internal static void Serialize(JsonWriter writer, ImpactSelector obj)
        {
