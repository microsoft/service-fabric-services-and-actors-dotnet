...
namespace Microsoft.ServiceFabric.Common
{
    ...
    /// </summary>
    public partial class BRSInfoPartitionEvent : PartitionEvent
    {
        /// <summary>
        /// Initializes a new instance of the BRSInfoPartitionEvent class.
        /// </summary>
        ...
        public BRSInfoPartitionEvent(
            ...
            : base(
                eventInstanceId,
                timeStamp,
                Common.FabricEventKind.BRSInfoPartition,
                partitionId,
                category,
                hasCorrelatedEvents)
        {
