...
namespace Microsoft.ServiceFabric.Common
{
    ...
    public class NodeName : IEquatable<NodeName>
    {
        ...
        public NodeName(string nodeName) => this.nodeName = nodeName;
        ...
        public bool IsEmpty => string.IsNullOrEmpty(nodeName);
        ...
        public static bool operator ==(NodeName name1, NodeName name2) => name1.Equals(name2);
        ...
        public bool Equals(NodeName other) => nodeName.Equals(other.nodeName);
        ...
        public override bool Equals(object other) => (other is NodeName) && nodeName.Equals(((NodeName)other).nodeName);

        /// <summary>
        /// Returns the hash code for this instance.
        /// </summary>
        /// <returns>The hash code for this instance.</returns>
        public override int GetHashCode() => nodeName.GetHashCode();
    }
}
