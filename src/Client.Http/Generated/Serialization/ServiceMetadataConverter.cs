...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ServiceMetadata" />.
    /// </summary>
    internal class ServiceMetadataConverter
    {
        /// <summary>
        ...
        internal static ServiceMetadata Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ServiceMetadata GetFromJsonProperties(JsonReader reader)
        {
        ...
        internal static void Serialize(JsonWriter writer, ServiceMetadata obj)
        {
