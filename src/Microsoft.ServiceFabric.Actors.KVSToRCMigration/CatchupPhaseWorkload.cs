...
namespace Microsoft.ServiceFabric.Actors.KVSToRCMigration
{
    ...
    internal class CatchupPhaseWorkload : MigrationPhaseWorkloadBase
    {
        public CatchupPhaseWorkload(
            ...
            string traceId)
            : base(MigrationPhase.Catchup, curentIteration, 1, stateProvider, servicePartitionClient, statefulServiceContext, migrationSettings, initParams, actorTypeInfo, traceId)
        {
        }
    }
}
