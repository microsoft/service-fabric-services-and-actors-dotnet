...
namespace Microsoft.ServiceFabric.Actors.Remoting.FabricTransport
{
    ...
    /// Fabric TCP transport to create <see cref="Microsoft.ServiceFabric.Services.Remoting.Client.IServiceRemotingClient"/> that communicate with 
    /// actors over interfaces that are remoted via 
    /// <see cref="Microsoft.ServiceFabric.Services.Remoting.FabricTransport.Runtime.FabricTransportServiceRemotingListener"/>.
    /// </summary>
