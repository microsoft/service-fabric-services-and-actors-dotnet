...
namespace Microsoft.ServiceFabric.Actors.Runtime
{
    internal sealed class ActorManager : IActorManager
    {
            ...
            CancellationToken innerCancellationToken)
        {
            ...
            {
                this.diagnostics.ActorMethodFinish(new ActorMethodDiagnosticData() { ActorId = actor.Id, InterfaceMethodKey = interfaceMethodKey, MethodId = methodId, Exception = e, RemotingListener = RemotingListenerVersion.V2 }, startTime);
                throw;
            }
            ...
            return dispatchTask.ContinueWith(
                t =>
                {
                    ...
                    this.diagnostics.ActorMethodFinish(new ActorMethodDiagnosticData() { ActorId = actor.Id, InterfaceMethodKey = interfaceMethodKey, MethodId = methodId, Exception = null, RemotingListener = RemotingListenerVersion.V2 }, startTime);
