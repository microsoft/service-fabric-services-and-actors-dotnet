    ...
    public sealed class ActorTypeInformation
    {
        ...
        public static ActorTypeInformation Get(Type actorType)
        {
...
#if !DotNetCoreClr
            var remotingListenerVersion = Services.Remoting.RemotingListenerVersion.V1;
#else
            var remotingListenerVersion = Services.Remoting.RemotingListenerVersion.V2;
#endif
            ...
            return new ActorTypeInformation()
            {
                ...
                RemotingListenerVersion = remotingListenerVersion
            };
        }
