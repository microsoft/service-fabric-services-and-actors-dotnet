...
namespace Microsoft.ServiceFabric.Actors.Runtime.Migration
{
    ...
    {
        internal static readonly string MigrationStartEvent = "TelemetryEvents.MigrationStartEvent";
        internal static readonly string MigrationEndEvent = "TelemetryEvents.MigrationEndEvent";
        internal static readonly string MigrationPhaseStartEvent = "TelemetryEvents.MigrationPhaseStartEvent";
