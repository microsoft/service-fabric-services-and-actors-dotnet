...
namespace Microsoft.ServiceFabric.Actors {
    ...
    internal class SR {
        ...
        /// <summary>
        ///   Gets a localized string similar to Actor id {0} was deleted using DeleteActorAsync while this call was in prgoress. This call should be retried.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to idleTimeoutInSeconds must be greater than or equal to scanIntervalInSeconds.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Specified value must be greater than 0.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Reminders cannot be registered or unregistered on Actor {0} because it doesnt implement IRemindable.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to this method can only be called on ActorProxy.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to the actor state name &apos;{0}&apos; already exist.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to the Actor state &apos;{0}&apos; was already removed in current call context.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Acquisition of turn based concurrency lock for actor &apos;{0}&apos; timed out after {1}.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Delete request for Actor {0} cannot be processed now since the actor is loading reminders. Please try again later.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Invalid value for Continuation token.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to the actor type &apos;{0}&apos; is abstract. Abstract actors cannot be registered as they cannot be instantiated.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to failed to deserialize ActorMessageHeaders.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Method &apos;{0}&apos; of actor interface &apos;{1}&apos; does not return Task or Task&lt;&gt;. The actor interface methods must be async and must return either Task or Task&lt;&gt;.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Method &apos;{0}&apos; of actor interface &apos;{1}&apos; is using generics. The actor interface methods cannot use generics.
        /// </summary
        ...
        /// <summary>
        ///   Gets a localized string similar to Method &apos;{0}&apos; of actor interface &apos;{1}&apos; has out/ref/optional parameter &apos;{2}&apos;. The actor interface methods must not have out, ref or optional parameters.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Method &apos;{0}&apos; of actor interface &apos;{1}&apos; has variable length parameter &apos;{2}&apos;. The actor interface methods must not have variable length parameters.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Method &apos;{0}&apos; of actor interface &apos;{1}&apos; is using a variable argument list. The actor interface methods cannot have a variable argument list.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Method &apos;{0}&apos; of actor interface &apos;{1}&apos; is overloaded. The actor interface methods cannot be overloaded.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Actor {0} is not found in the input assembly. Ensure that it derives from either {1} or {2} and implements and {3} interface.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to &quot;{0}&lt;{1}&gt;: Actor state must have a callable constructor and be serializable.&quot;.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Failed to determine the current application, please provide application name.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to could not cast {0} to {1}.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Failed to deserialize and get remote exception.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Actor {0}  got same request more than once. This might happen for a request which takes more processing time than configured OperationTimeout 
        ...
        /// <summary>
        ///   Gets a localized string similar to cannot determine the event interface from the supplied generic type argument. Supply the event interface type.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to the type &apos;{0} is not an actor events interface. The actor event interface must only derive from &apos;{1}&apos;.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Method &apos;{0}&apos; of actor interface &apos;{1}&apos; returns &apos;{2}. The actor event interface methods must not return anything. The return type must be &apos;{3}&apos;.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Method &apos;{0}&apos; of actor event interface &apos;{1}&apos; is using generics. The actor event interface methods cannot use generics.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Method &apos;{0}&apos; of actor event interface &apos;{1}&apos; has out/ref/optional parameter &apos;{2}&apos;. The actor event interface methods must not have out, ref or optional parameters.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Method &apos;{0}&apos; of actor event interface &apos;{1}&apos; has variable length parameter &apos;{2}&apos;. The actor event interface methods must not have variable length parameters.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Method &apos;{0}&apos; of actor event interface &apos;{1}&apos; is using a variable argument list. The actor event interface methods cannot have a variable argument list.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Method &apos;{0}&apos; of actor event interface &apos;{1}&apos; is overloaded. The actor event interface methods cannot be overloaded.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Event with eventId &apos;{0}&apos; is not supported by Actor with actorId &apos;{1}&apos;.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to HighestSequenceNumber({0}) &lt; UpToSequenceNumber({1}).
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Method Id &apos;{0}&apos; is not available for ActorEventSubscription.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Invalid ReminderAttribute.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to No MethodDispatcher is found for interface id &apos;{0}&apos;.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to &apos;{0}&apos; method is not supported for type &apos;{1}&apos;.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to the type &apos;{0}&apos; must implement only one actor interface.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Actor State with name {0} was not found.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to the actor interface {0} is implemented by actor types {1} and {2}. In order for the client to connect to the right actor, please add {3} attribute with valid Name on the both actor types. Please use this Name as serviceName parameter when creating ActorProxy.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to the actor type {0} implements more than one actor interfaces. In order for the client to connect to the right actor, please add {1} attribute with valid Name on the actor type. Please use this Name as serviceName parameter when creating ActorProxy.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Actor state has no callable constructors with default argument values.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Actor state has no constructors.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to the type &apos;{0}&apos; is not an Actor. An actor type must derive from &apos;{1}&apos;.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to the type &apos;{0}&apos; is not an actor interface as it does not derive from the interface &apos;{1}&apos;.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to the type &apos;{0}&apos; is not an actor interface as it derive from a non actor interface &apos;{1}&apos;. All actor interfaces must derive from &apos;{2}&apos;.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to the type &apos;{0}&apos; is not an Actor interface as it is not an interface.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to OnDataLossAsync can only be set once.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Null {0} in replicator settings.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Actor activated. Actor type: {0}, actor ID: {1}, replica/instance ID: {3}, partition ID: {4}.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Actor deactivated. Actor type: {0}, actor ID: {1},  replica/instance ID: {3}, partition ID: {4}.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Number of actor method calls waiting for the actor lock: {0}, actor type: {1}, actor ID: {2}.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Actor method is being invoked. Method name: {0}, actor type: {2}, actor ID: {3}.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Actor method has completed. Method name: {1}, actor type: {3}, actor ID: {4}.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Actor&apos;s async method threw an exception. Method name: {2}, actor type: {4}, actor ID: {5}, exception: {0}.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Starting to save actor state. Actor type: {0}, actor ID: {1}.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Finished saving actor state. Actor type: {1}, actor ID: {2}.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Actor type {0} registered.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Failed to register actor type {1}. Exception: {0}.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Actor replica changed role to non-Primary. Replica ID: {0}, partition ID: {1}.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Actor replica changed role to Primary. Replica ID: {0}, partition ID: {1}.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to the method &apos;{0}&apos; is not valid for &apos;{1}&apos; ActorId.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Invalid value for argument IsReadOnly &apos;{0}&apos; for non-existing Actor state &apos;{1}&apos;.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Actor {0} can be decorated with atmost one Reentrancy attribute.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to a reentrant call has been made from actor while there are other outstanding actor calls. Atmost one reentrant call is allowed at a time.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to StateChangeKind can only be add, update or remove.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to ActorMethod.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to ActorState.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Default.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Actor {0} does not allow reentrant calls. ReentrancyMode must be set to LogicalCallContext to allow reentrant calls.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to a reentrant call to Actor {0} found its state to be dirty. This typically indicates programming error.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Reminder {0} was not found for Actor {1}.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Reminder cannot be registered for type {0} because the class does not implement {1}.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Invalid Content.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to TimeSpan TotalMilliseconds specified value must be between {0} and {1}.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to the system has a counter with the same category and counter name, but its counter type is not what we expect.
        /// </summary>
        ...
        /// <summary>
        ///   Gets a localized string similar to Reminder {0} for Actor {1} cannot be registered or unregistered since the actor is loading reminders. Please try again later.
        /// </summary>
