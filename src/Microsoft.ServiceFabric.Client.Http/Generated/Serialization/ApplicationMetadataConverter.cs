...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ApplicationMetadata" />.
    /// </summary>
    internal class ApplicationMetadataConverter
    {
        /// <summary>
        ...
        internal static ApplicationMetadata Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ApplicationMetadata GetFromJsonProperties(JsonReader reader)
        {
        ...
        internal static void Serialize(JsonWriter writer, ApplicationMetadata obj)
        {
