...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="BRSInfoPartitionEvent" />.
    /// </summary>
    internal class BRSInfoPartitionEventConverter
    {
        /// <summary>
        ...
        internal static BRSInfoPartitionEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static BRSInfoPartitionEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new BRSInfoPartitionEvent(
        ...
        internal static void Serialize(JsonWriter writer, BRSInfoPartitionEvent obj)
        {
