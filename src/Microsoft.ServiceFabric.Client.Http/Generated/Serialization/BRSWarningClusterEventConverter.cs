...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="BRSWarningClusterEvent" />.
    /// </summary>
    internal class BRSWarningClusterEventConverter
    {
        /// <summary>
        ...
        internal static BRSWarningClusterEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static BRSWarningClusterEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new BRSWarningClusterEvent(
        ...
        internal static void Serialize(JsonWriter writer, BRSWarningClusterEvent obj)
        {
