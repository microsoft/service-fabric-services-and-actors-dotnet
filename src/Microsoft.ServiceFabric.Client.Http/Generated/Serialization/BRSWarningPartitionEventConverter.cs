...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="BRSWarningPartitionEvent" />.
    /// </summary>
    internal class BRSWarningPartitionEventConverter
    {
        /// <summary>
        ...
        internal static BRSWarningPartitionEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static BRSWarningPartitionEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new BRSWarningPartitionEvent(
        ...
        internal static void Serialize(JsonWriter writer, BRSWarningPartitionEvent obj)
        {
