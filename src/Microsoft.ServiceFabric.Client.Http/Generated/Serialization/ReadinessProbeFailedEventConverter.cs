...
namespace Microsoft.ServiceFabric.Client.Http.Serialization
{
    ...
    /// <summary>
    /// Converter for <see cref="ReadinessProbeFailedEvent" />.
    /// </summary>
    internal class ReadinessProbeFailedEventConverter
    {
        /// <summary>
        ...
        internal static ReadinessProbeFailedEvent Deserialize(JsonReader reader)
        {
        ...
        /// <returns>The object Value.</returns>
        internal static ReadinessProbeFailedEvent GetFromJsonProperties(JsonReader reader)
        {
            ...
            return new ReadinessProbeFailedEvent(
        ...
        internal static void Serialize(JsonWriter writer, ReadinessProbeFailedEvent obj)
        {
