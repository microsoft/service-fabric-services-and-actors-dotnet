...
namespace Microsoft.ServiceFabric.Common
{
    ...
    /// </summary>
    public partial class BRSWarningClusterEvent : ClusterEvent
    {
        /// <summary>
        /// Initializes a new instance of the BRSWarningClusterEvent class.
        /// </summary>
        ...
        public BRSWarningClusterEvent(
            ...
            : base(
                eventInstanceId,
                timeStamp,
                Common.FabricEventKind.BRSWarningCluster,
                category,
                hasCorrelatedEvents)
        {
