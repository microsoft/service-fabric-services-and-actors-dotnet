...
namespace Microsoft.ServiceFabric.Powershell.Http
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "SFUnplacedReplicaInformation")]
    public partial class GetUnplacedReplicaInformationCmdlet : CommonCmdletBase
    {
        /// <summary>
        ...
        {
            var result = this.ServiceFabricClient.Services.GetUnplacedReplicaInformationAsync(
                serviceId: this.ServiceId,
                partitionId: this.PartitionId,
                onlyQueryPrimaries: this.OnlyQueryPrimaries,
