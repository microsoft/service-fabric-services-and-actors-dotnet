...
namespace Microsoft.ServiceFabric.Services.Remoting.Mesh.Client
{
    ...
    public class ServiceProxyFactory
    {
        ...
        /// </param>
        /// <returns>The proxy that implement the interface that is being remoted. The returned object also implement <see cref="IServiceProxy"/> interface.
        /// </returns>
        ...
        public void Dispose()
        {
            ...
            {
                var castedFactory = this.remotingClientFactory as FabricTransportServiceRemotingClientFactory;
