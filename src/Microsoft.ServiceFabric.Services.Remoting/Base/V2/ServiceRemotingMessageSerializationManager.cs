...
namespace Microsoft.ServiceFabric.Services.Remoting.Base.V2
{
    ...
    internal abstract class ServiceRemotingMessageSerializationManager
    {
        ...
        public ServiceRemotingMessageSerializationManager(
        ...
        internal virtual CacheEntry CreateSerializers(int interfaceId)
        {
            ...
            return new CacheEntry(
                this.serializationProvider.CreateRequestMessageSerializer(
                    serviceInterfaceType,
                    requestBodyTypes,
                    interfaceDetails.RequestWrappedKnownTypes),
                this.serializationProvider.CreateResponseMessageSerializer(
                    serviceInterfaceType,
                    responseBodyTypes,
                    interfaceDetails.ResponseWrappedKnownTypes));
        }

        internal abstract InterfaceDetails GetInterfaceDetails(int interfaceId);
    }
}
