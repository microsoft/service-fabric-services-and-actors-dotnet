...
namespace Microsoft.ServiceFabric.Services.Remoting.Builder
{
        ...
        where TMethodDispatcher : MethodDispatcherBase
    {
        ...
        private static IReadOnlyDictionary<int, string> GetMethodNameMap(InterfaceDescription interfaceDescription)
        {
           ...
           Type responseType)
        {
            ...
            if (ctorInfo != null)
            {
                ...
                ilGen.Emit(fInfo.FieldType.GetTypeInfo().IsClass ? OpCodes.Castclass : OpCodes.Unbox_Any, fInfo.FieldType);
