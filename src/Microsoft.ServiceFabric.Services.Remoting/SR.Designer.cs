...
namespace Microsoft.ServiceFabric.Services.Remoting {
    ...
    internal class SR {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The type &apos;{0}&apos; is not a service interface as it does not derive from the interface &apos;{1}&apos;.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to The type &apos;{0}&apos; is not a service interface as it derive from a non service interface &apos;{1}&apos;. All service interfaces must derive from &apos;{2}&apos;.
        /// </summary>
