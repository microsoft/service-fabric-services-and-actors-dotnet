...
namespace Microsoft.ServiceFabric.Services.Remoting.V2.Runtime
{
    ...
    public class ServiceRemotingMessageDispatcher : IServiceRemotingMessageHandler, IDisposable
    {
        ...
        {
            this.messageDispatcher = new Base.V2.Runtime.ServiceRemotingMessageDispatcher(
                serviceContext.PartitionId,
                serviceContext.ReplicaOrInstanceId,
                serviceContext.TraceId.ToString(),
                serviceImplementation,
                this.GetDispatcherMap(serviceImplementation, remotedInterfaces),
                this.GetKnownTypes,
                nonServiceInterface,
