...
namespace Microsoft.ServiceFabric.Powershell.Http
{
    ...
    public partial class DisableServiceCmdlet : CommonCmdletBase
    {
        ...
        /// <summary>
        /// Gets or sets DisableServiceFlag. Specifies the behavior when disabling a service. Possible values include:
        /// 'Invalid', 'RemoveData'
        /// </summary>
        ...
        {
            var disableServiceDescription = new DisableServiceDescription(
