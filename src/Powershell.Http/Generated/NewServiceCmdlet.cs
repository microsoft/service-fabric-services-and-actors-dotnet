...
namespace Microsoft.ServiceFabric.Powershell.Http
{
    ...
    public partial class NewServiceCmdlet : CommonCmdletBase
    {
        ...
        /// <summary>
        /// Gets or sets IsCreateAsDisabled. Indicates whether the service should be created in a disabled state. When set to
        /// true, the service is created without placing any replicas or instances. The service stays disabled until you
        /// explicitly enable it. The default value is false.
        /// </summary>
        [Parameter(Mandatory = false, Position = 26)]
        public bool? IsCreateAsDisabled { get; set; } = false;
        ...
        protected override void ProcessRecordInternal()
        {
            ...
            if (this.Stateful.IsPresent)
            {
                serviceDescription = new StatefulServiceDescription(
                    ...
                    isCreateAsDisabled: this.IsCreateAsDisabled,
                    flags: this.Flags,
