...
namespace Microsoft.ServiceFabric.AspNetCore.Tests
{
    ...
    public class AspNetCoreCommunicationListenerTests
    {
        ...
        protected void UseUniqueServiceUrlOptionVerifier()
        {
            ...
            Assert.Equal(expectedUrlToBuildFunc, this.urlFromListenerToBuildFunc); // listener generates the url.
            Assert.Equal(actualUrlFromOpen, actualUrlFromOpen); // url from OpenAsync with endpoint ref
        ...
        protected void WithoutUseUniqueServiceUrlOptionVerifier()
        {
            ...
            Assert.Equal(expectedUrlToBuildFunc, this.urlFromListenerToBuildFunc); // url to Build Func is generated by listener
            Assert.Equal(expectedUrlFromOpen, actualUrlFromOpen); // url from OpenAsync with endpoint ref
            Console.WriteLine("Completed Verification of urls with endpoint ref");
        }
