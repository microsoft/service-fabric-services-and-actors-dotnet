...
namespace Microsoft.ServiceFabric.Diagnostics.Metrics.Implementation
{
    public abstract class Meter2DTest
    {
        ...
        public class Constructor : Meter2DTest
        {
            ...
            {
                var exception = Xunit.Record.Exception(() => new Mock<Meter2D>(null, systemDimensions).Object);
            ...
            {
                var exception = Xunit.Record.Exception(() => new Mock<Meter2D>(fabricMeter, null).Object);
                Assert.IsType<ArgumentNullException>(exception.InnerException);
            }
        }
