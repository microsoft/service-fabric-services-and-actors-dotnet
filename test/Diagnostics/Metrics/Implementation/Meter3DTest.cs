...
namespace Microsoft.ServiceFabric.Diagnostics.Metrics.Implementation
{
    public abstract class Meter3DTest
    {
        ...
        public class Constructor : Meter3DTest
        {
            ...
            {
                var exception = Xunit.Record.Exception(() => new Mock<Meter3D>(null, systemDimensions).Object);
            ...
            {
                var exception = Xunit.Record.Exception(() => new Mock<Meter3D>(fabricMeter, null).Object);
                Assert.IsType<ArgumentNullException>(exception.InnerException);
            }
        }
