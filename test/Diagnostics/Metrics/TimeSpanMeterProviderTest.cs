    ...
    public class TimeSpanMeterProviderTest : FabricTelemetryDllFixture
    {
        ...
        public class CreateMeter : TimeSpanMeterProviderTest
        {
            ...
            public void CreatesMeterWithCorrectDimensionsAndMeter()
            {
                ...
                Assert.Equal(systemDimensionsValues, ((TimeSpanMeter)meter).Field<IEnumerable<string>>().Value);
            }
            ...
            public void CreatesMeterWithCorrectDimensionsAndMeter1D()
            {
                ...
                Assert.Equal(systemDimensionsValues, ((TimeSpanMeter1D)meter1D).Field<IEnumerable<string>>().Value);
            }
            ...
            public void CreatesMeterWithCorrectDimensionsAndMeter2D()
            {
                ...
                Assert.Equal(systemDimensionsValues, ((TimeSpanMeter2D)meter2D).Field<IEnumerable<string>>().Value);
            }
            ...
            public void CreatesMeterWithCorrectDimensionsAndMeter3D()
            {
                ...
                Assert.Equal(systemDimensionsValues, ((TimeSpanMeter3D)meter3D).Field<IEnumerable<string>>().Value);
            }
        }
    }
}
