...
{
    public class TimeSpanMeterTest3D
    {
        readonly IMeter3D<TimeSpan> sut;
        ...
        public TimeSpanMeterTest3D() => sut = new TimeSpanMeter3D(fabricMeter, systemDimensions);

        public class Class : TimeSpanMeterTest3D
        {
            [Fact]
        ...
        public class Record : TimeSpanMeterTest3D
        {
            ...
            public void CallsFabricMeterRecordWithNoSystemDimensions()
            {
                ...
                // Act
                var meter = new TimeSpanMeter3D(fabricMeter, new List<string>());
