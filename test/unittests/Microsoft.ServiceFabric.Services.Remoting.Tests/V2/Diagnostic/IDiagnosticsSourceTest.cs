    ...
    public abstract class IDiagnosticsSourceTest
    {
        public class Signiture : IDiagnosticsSourceTest
        {
            ...
            public void IDiagnosticsSource_ShouldHave_RequiredMethods()
            {
                ...
                var onCreateRemotingMessageBeginMethod = interfaceType.GetMethod("OnCreateRemotingMessageBegin", new Type[0]);
                ...
                var onCreateRemotingMessageEndMethod = interfaceType.GetMethod("OnCreateRemotingMessageEnd", new[] { typeof(DateTime) });
